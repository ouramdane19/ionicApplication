...
var DetailImagePage = /** @class */ (function () {
    ...
    DetailImagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-detail-image',template:/*ion-inline-start:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/pages/detail-image/detail-image.html"*/'\n<ion-header>\n\n  <ion-navbar color="dark">\n    <ion-title>Détails de l\'image </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content >\n  <ion-card>\n    <ion-card-header class="myCardHeader">\n      <ion-item >\n        <ion-avatar item-start>\n            <img src="{{image.userImageURL}}" >\n          </ion-avatar>\n          <h2>{{image.user}}</h2>\n        <p>{{image.user_id}}</p>\n       </ion-item>\n    </ion-card-header>\n    <img src="{{image.webformatURL}}">\n    <ion-card-content>\n      <ion-row>\n        <ion-col>\n          <button ion-button icon-start clear small>\n            <ion-icon name="thumbs-up"></ion-icon>\n            <div>{{image.likes}} Likes</div>\n          </button>\n        </ion-col>\n        <ion-col>\n          <button ion-button icon-start clear small>\n            <ion-icon name="text"></ion-icon>\n            <div>{{image.comments}} Commentes </div>\n          </button>\n        </ion-col>\n        <ion-col>\n          <button ion-button icon-start clear small>\n            <ion-icon name="text"></ion-icon>\n            <div>{{image.favorites}} Favorites</div>\n          </button>\n        </ion-col>\n      </ion-row>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n'/*ion-inline-end:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/pages/detail-image/detail-image.html"*/,
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar color="dark">\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content >\n      <ion-list id=listeMenu >\n        <button menuClose="" ion-item="" *ngFor="let item of items" (click)="itemSelected(item)">{{item.title}}</button>\n      </ion-list>\n  </ion-content>\n</ion-menu>\n\n<ion-nav #content [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/app/app.html"*/
        }),
...
var DetailsPhotoPage = /** @class */ (function () {
    ...
    DetailsPhotoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-details-photo',template:/*ion-inline-start:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/pages/details-photo/details-photo.html"*/'\n<ion-header>\n  <ion-navbar color="dark">\n    <ion-title>detailsPhoto</ion-title>\n    <ion-buttons end="">\n        <button ion-button="" icon-only (click)="deletePicture()" >\n         <ion-icon name="trash"></ion-icon>\n        </button> \n        </ion-buttons>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <img [src]="image" class="rounded-top" >\n</ion-content>\n'/*ion-inline-end:"/home/ouramdane/Documents/myFirstApplication/ionicApplication/src/pages/details-photo/details-photo.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], DetailsPhotoPage);
